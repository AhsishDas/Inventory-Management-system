<div class="panel panel-info">
  <div class="panel-heading">Other income List</div>
    ...
    <table class="table table-bordered">
      ...
      <?php
        ...
        foreach($recieptInfo as $row) {
          ...
          echo '<td>';
          echo '<a href="/markazboys/index.php/accounting/otherIncomeEditForm?recieptid='.$row['reciept_id'].'" class="btn btn-warning">Edit</a>';
          echo '</td>';
          echo '</tr>';
          $count ++;
        }
