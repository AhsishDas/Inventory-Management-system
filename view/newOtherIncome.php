...
<div class="panel panel-info">
  <div class="panel-heading">Other Income Sources</div>
  <div class="panel-body">
    <form action="<?php echo '/markazboys/index.php/accounting/newOtherIncomeAction'; ?>" method="POST">
      <textfield>
        <legend>New Other Income Sources</legend>
